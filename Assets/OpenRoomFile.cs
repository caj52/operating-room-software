...
public class OpenRoomFile : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        loadButton.onClick.AddListener(()=> StartCoroutine(ShowLoadDialogCoroutine()));
    ...
    void OnFilesSelected(string[] filePaths)
    {
        ...
        ConfigurationManager.Instance.LoadRoom(filePath);
